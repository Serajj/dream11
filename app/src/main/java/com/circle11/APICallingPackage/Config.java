package com.circle11.APICallingPackage;


public class Config {

    public static String SERVERURL = "https://circle11.ecartshop.xyz/";
    ...
    //APK URL
    public static String APKURL = SERVERURL+"apk/Circle11.apk";
    //APK NAME
    public static String APKNAME = "Circle11.apk";
