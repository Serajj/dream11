...
import com.circle11.utils.AppEnvironment;
import com.circle11.utils.AppPreference;
import com.circle11.application.BaseApplication;
...
import com.circle11.APICallingPackage.Class.APIRequestManager;
import com.circle11.APICallingPackage.Interface.ResponseManager;
import com.circle11.APICallingPackage.Config;
import com.circle11.R;
import com.circle11.utils.SessionManager;
...
import static com.circle11.APICallingPackage.Config.ADDAMOUNT;
import static com.circle11.APICallingPackage.Constants.ADDAMOUNTTYPE;
...
public class PayUMoneyPaymentActivity extends AppCompatActivity implements View.OnClickListener,ResponseManager {
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(PayUMoneyPaymentActivity.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(PayUMoneyPaymentActivity.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (v.getId() == R.id.tv_Logout || validateDetails(userEmail, userMobile,userName)) {
            switch (v.getId()) {
                case R.id.tv_Checkout:
                    ...
                    Log.d("serajpayu","Launching Flow");
                    launchPayUMoneyFlow();
                    break;
                case R.id.tv_Logout:
...
/*            *//**
           ...
           if (AppPreference.selectedTheme != -1) {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,PayUMoneyPaymentActivity.this, AppPreference.selectedTheme,mAppPreference.isOverrideResultScreen());
            } else {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,PayUMoneyPaymentActivity.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
            }
    ...
    (final PayUmoneySdkInitializer.PaymentParam paymentParam) {
        ...
        AppEnvironment appEnvironment = ((BaseApplication) getApplication()).getAppEnvironment();
        stringBuilder.append("lLqy8YlV9z");
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PayUMoneyPaymentActivity.this);
        ...
        protected void onPostExecute(String merchantHash) {
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(PayUMoneyPaymentActivity.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
                mPaymentParams.setMerchantHash(merchantHash);
                Log.d("serajhashnew",merchantHash);
                if (AppPreference.selectedTheme != -1) {
                    PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams, PayUMoneyPaymentActivity.this, AppPreference.selectedTheme, mAppPreference.isOverrideResultScreen());
                } else {
                    PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams, PayUMoneyPaymentActivity.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
